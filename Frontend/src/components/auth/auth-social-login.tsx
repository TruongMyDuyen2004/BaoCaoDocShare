...
export function AuthSocialLogin({ provider, label, onClick, disabled }: AuthSocialLoginProps) {
  ...
  return (
    <button
      type="button"
      className={`w-full flex items-center justify-center py-2.5 sm:py-3 bg-white/5 border border-white/10 rounded-lg sm:rounded-xl text-sm sm:text-base transition-colors duration-300 ${
        disabled 
